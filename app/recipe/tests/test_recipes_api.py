...
class PublicRecipesApiTests(TestCase):
    """
    Tests publicly available (unauthenticated) API access
    """
    def setUp(self):
...
class PrivateRecipesApiTests(TestCase):
    """
    Tests private API access for authenticated users
    """
    ...
    def test_recipes_limited_to_user(self):
        """Tests recipes are limited to auth'd user"""
    ...
    def test_view_recipe_detail(self):
        """Tests viewing a recipe's details"""
    ...
    def test_partial_update_recipe(self):
        """Tests a partial update of a recipe with PATCH"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
    ...
    def test_full_update_recipe(self):
        """Tests a full update of a recipe with PUT"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        """Tests uploading an image to a recpie"""
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe2 = sample_recipe(user=self.user, title="Chicken Calciatori")
